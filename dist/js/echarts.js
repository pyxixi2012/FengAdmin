...
var dataChart = echarts.init(document.getElementById('data'));
var xAxisData = [];
var data1 = [];
var data2 = [];
for (var i = 0; i < 100; i++) {
...
timeTicket = setInterval(function () {
    dashoption.series[0].data[0].value = (Math.random() * 100).toFixed(2) - 0;
    dashChart.setOption(dashoption, true);
},2000);

dashChart.setOption(dashoption);
